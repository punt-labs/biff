...
from $inFlight$, clears the changed flags, and does not touch
$pendingNotify$---the suspenders path never has anything of its own to
flush, only the current tick's own delivery to report.

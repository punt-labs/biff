...
% (DESIGN.md).  Logged by the parallel code-implementation mission
% (m-2026-08-09-021, worker rmh, same design mission m-2026-08-09-018)
% for the code-side half of this fix; this section is the corresponding
% formal-model half.  Confirmed present in DESIGN.md at the time this
% comment was written (grep "^## DES-054" DESIGN.md), not guessed.

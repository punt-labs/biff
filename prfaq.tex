...
\begin{faqpair}{What is the estimated development timeline?}
  \begin{description}[leftmargin=1.5em, labelwidth=10em, font=\bfseries]
    ...
    \item[Next: Team Coordination] \texttt{/wall} (team broadcast).
    Plan auto-expand (\texttt{/plan
...
\subsection*{Next: Team Coordination}
...
\begin{tabularx}{\textwidth}{@{}l X@{}}
  ...
  immediately on the status bar with duration-based expiry. Does not go
  to inboxes --- it is a banner, not a message. \\

...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/aa7ee0f/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/aa7ee0f/install.sh -o install.sh

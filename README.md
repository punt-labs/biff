...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/5c1a9c4/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/5c1a9c4/install.sh -o install.sh

...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/90c1501/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/90c1501/install.sh -o install.sh

...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/01ef36e/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/01ef36e/install.sh -o install.sh

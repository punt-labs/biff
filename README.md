...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/904f8f7/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/904f8f7/install.sh | sh -s -- --no-plugin
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/904f8f7/install.sh | BIFF_NO_PLUGIN=1 sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/904f8f7/install.sh -o install.sh

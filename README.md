...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/f807aa7/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/f807aa7/install.sh -o install.sh

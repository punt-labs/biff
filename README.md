...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/4926e22/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/4926e22/install.sh -o install.sh

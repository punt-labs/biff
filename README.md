...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/927ee2b/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/927ee2b/install.sh -o install.sh

...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/5a08248/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/5a08248/install.sh -o install.sh

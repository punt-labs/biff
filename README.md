...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/dad9209/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/dad9209/install.sh -o install.sh

...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/a0ea7ab/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/a0ea7ab/install.sh -o install.sh

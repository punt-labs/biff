...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/3c99c98/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/3c99c98/install.sh -o install.sh

...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/164353d/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/164353d/install.sh -o install.sh

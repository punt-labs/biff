...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/0baa97e/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/0baa97e/install.sh -o install.sh

...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/e305b6f/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/e305b6f/install.sh -o install.sh

...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/6647733/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/6647733/install.sh -o install.sh

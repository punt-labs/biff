...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/9149bdc/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/9149bdc/install.sh -o install.sh

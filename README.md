...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/22ad973/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/22ad973/install.sh -o install.sh

...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/a1f9f3b/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/a1f9f3b/install.sh -o install.sh

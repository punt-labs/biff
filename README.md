...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/f966c08/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/f966c08/install.sh -o install.sh

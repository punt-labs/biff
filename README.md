...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/e1ba5e6/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/e1ba5e6/install.sh -o install.sh

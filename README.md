...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/18633db/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/18633db/install.sh -o install.sh

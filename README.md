...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/dabfc63/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/dabfc63/install.sh -o install.sh

...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/146849e/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/146849e/install.sh -o install.sh

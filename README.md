...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/ddf641d/install.sh | sh -s -- --no-plugin
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/ddf641d/install.sh | BIFF_NO_PLUGIN=1 sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/biff/ddf641d/install.sh -o install.sh
